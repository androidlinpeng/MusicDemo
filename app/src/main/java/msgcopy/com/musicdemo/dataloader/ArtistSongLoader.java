package msgcopy.com.musicdemo.dataloader;
...
public class ArtistSongLoader {
            ...
            public void call(Subscriber<? super List<Song>> subscriber) {
                ...
                if ((cursor != null) && (cursor.moveToFirst()))
                    do {
                        ...
                        songsList.add(new Song(id, albumId, artistId, title, artist, album, duration, trackNumber,path));
                    }
    ...
    private static Cursor makeArtistSongCursor(Context context, long artistID) {
        ...
        return contentResolver.query(uri, new String[]{"_id", "title", "artist", "album", "duration", "track", "album_id","artist_id", MediaStore.Audio.Media.DATA}, string, null, artistSongSortOrder);
    }
}
