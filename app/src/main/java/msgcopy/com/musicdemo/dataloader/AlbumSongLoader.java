...
public class AlbumSongLoader {
    ...
    private static Cursor makeAlbumSongCursor(Context context, long albumID) {
        ...
        Cursor cursor = contentResolver.query(uri, new String[]{"_id", "title", "artist", "album", "duration", "track", "artist_id","album_id", MediaStore.Audio.Media.DATA}, string, null, albumSongSortOrder);
        return cursor;
    }
}
